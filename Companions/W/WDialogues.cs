...
namespace DocterMain.Companions.Docter
{
    ...
    public class WDialogues : CompanionDialogueContainer //Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        ...
        public override string NormalMessages(Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
            ...
            if (WorldMod.HasCompanionNPCSpawned(6u, "DocterMain"))
            {
                Mes.Add("Scout is more expensive than me... yes.");
            }
