...
namespace DocterMain.Companions.Docter
{
    ...
    public class JessicatheLiberatedDialogues : CompanionDialogueContainer //Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        public override string GreetMessages(Companion companion) //Messages for when you just met the companion.
        {
            return "I haven't seen you for a long time, Doctor. I'm glad I can still work for you. Yes, I have made many changes. If I could spare some time, I really would like to talk to you...";
        }
        ...
        public override string NormalMessages(Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
            ...
            Mes.Add("Good morning! I hope you slept well and your breakfast was delicious. Anyway, are you up for some work? I'm in a good mood today, so let's get straight to it.");
            Mes.Add("Good morning! Glad to see you today. Did you have a great night's sleep? I was just checking out the schedule for the day.");
            ...
            Mes.Add("In the world I came from, we fight while our Doc gives us orders. It is quite nice that he I'm fighting alongside my Doc.");
