...
namespace DocterMain.Companions.Docter
{
    ...
    public class SurtrDialogues : CompanionDialogueContainer //Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        public override string GreetMessages(Companion companion) //Messages for when you just met the companion.
        {
            return "I am Surtr. Are you the Doctor they mentioned? I will be working at Rhodes Island, starting today. I hope that you will not bore me too much.";
        }
        ...
        public override string NormalMessages(Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
            ...
            Mes.Add("Don't expect me to instruct others in Originium Arts. I have no interest in wasting time with plebeians.");
            Mes.Add("I'm not here because I have to, but because I want to.");
            Mes.Add("The people I hate most are the ones who ask too many questions. I hope you are not one of them.");
            Mes.Add("Tch... what a waste of time.");
        ...
        public override string JoinGroupMessages(Companion companion, JoinMessageContext context)
        {
            switch(context)
            {
                case JoinMessageContext.Success:
                    return "You've failed to complete the tasks within your purview, and are now asking me for help?";
