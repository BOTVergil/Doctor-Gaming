...
namespace DocterMain.Companions.Docter
{
    ...
    public class ACEDialogues : CompanionDialogueContainer //Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        public override string GreetMessages(Companion companion) //Messages for when you just met the companion.
        {
            return "Ah, my head. Doc? Is that you?";
        }
        ...
        public override string NormalMessages(Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
            ...
            {
                Mes.Add("The nurses here are not as good as Kal'tsit, [nn:" + Terraria.ID.NPCID.Nurse+ "] always intentionally increases prices.");
            }
