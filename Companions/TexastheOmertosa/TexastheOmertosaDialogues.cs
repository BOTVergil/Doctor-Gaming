...
namespace DocterMain.Companions.Docter
{
    ...
    public class TexastheOmertosaDialogues : CompanionDialogueContainer //Must be assigned on the companion base file, setting it as the value of "GetDialogueContainer" overrideable method.
    {
        public override string GreetMessages(Companion companion) //Messages for when you just met the companion.
        {
            return "We meet again, Doctor. The Siracusan rainy season always gets my tail wet, so I prefer the climate here. Don't worry, Exusiai and the girls will keep taking care of the deliveries, but I'll handle any jobs assigned to me personally.";
        }
        ...
        public override string NormalMessages(Companion companion) //Normal chitchat. If you want to get player reference, use MainMod.GetLocalPlayer.
        {
            ...
            Mes.Add("I'm your bodyguard again, just like old times, Doctor. And it's not just a job, it's a reunion. That's something worth cherishing.");
            ...
            if (WorldMod.HasCompanionNPCSpawned(2u, "DocterMain"))
            {
                Mes.Add("I didn't want to get Penguin Logistics involved, but it was a relief to see them in Siracusa. My noisy friends, that life of freedom... Looking back now, staying with them in Lungmen was the best decision I ever made. Just, don't tell them I said that.");
            }
