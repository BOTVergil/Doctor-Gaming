...
{
    public class AIBlueberryDarkChocolateProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Vector2 vector14 = Projectile.Center + Projectile.velocity * 0.1f; 
                ...
                int dcDust = Dust.NewDust(vector14 - Projectile.Size / 2f, Projectile.width, Projectile.height, 293, 0f, 0f, 150, default(Color), 0.9f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            origin.X = (float)((Projectile.spriteDirection == 1) ? (sourceRectangle.Width - 120) : 120);
